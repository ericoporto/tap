...
set INSTALL[2][name]=Adventure Game Studio 3.5.0
set INSTALL[2][version]=3.5.0.22
set INSTALL[2][url]=https://github.com/adventuregamestudio/ags/releases/download/v.3.5.0.22/AGS-3.5.0.22.exe
